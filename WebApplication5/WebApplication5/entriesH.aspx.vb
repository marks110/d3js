...
Public Class EntriesH
    Inherits System.Web.UI.Page

    Dim CheckBoxClicked As Boolean = False
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If (System.Web.HttpContext.Current.Session("Layout") = "vertical") Then
    ...
    'Protected Sub Page_Load_Complete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LoadComplete

    'Page.ClientScript.RegisterStartupScript(Me.GetType(), "Window", "alert('reloaded');", True)
    'Page.ClientScript.RegisterStartupScript(Me.GetType(), "Script", "raise_popup();", True)
    'Page.ClientScript.RegisterStartupScript(Me.GetType(), "Script", "select_iframe();", True)
    ...
    Protected Sub CheckBox_OnCheckedChanged(sender As Object, e As EventArgs)
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        If CheckBoxClicked = False Then
            ...
            If GridView1.SelectedIndex > -1 Then
                ...
                iframePDFViewer.Src = "getPDF.ashx?path=" & myPDFPath & "&filename=" & GridView1.SelectedRow.Cells(2).Text
    ...
    Private Function GetInstType(ByVal inst_name As String) As String
        ...
        If (inst_name = "LCMS-1" Or inst_name = "LCMS-4" Or inst_name = "LCMS-6" Or inst_name = "LCMS-7" Or inst_name = "LCMS-8" Or inst_name = "LCMS-12") Then
            mytype = "waters"
    ...
    Protected Sub Process_click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        System.Web.HttpContext.Current.Session("TYPE") = GetInstType(instName)
        ...
        Else
            'Dim newWin As String = "window.open('" + queryString + "','_blank', 'toolbar=0, scrollbars=0, resizable=1, width=760, height=760, channelmode=0, left=100,top=100, menubar=0, titlebar=0, status=0');"
            Dim newWin As String = "var popup = window.open('" + queryString + "','_blank', 'width=760, height=760, left=100, top=100').focus();"
    ...
    Protected Sub ChangeLayout_Click(sender As Object, e As EventArgs) Handles Button3.Click
        System.Web.HttpContext.Current.Session("Layout") = "vertical"
        Response.Redirect("entries.aspx")
    End Sub
