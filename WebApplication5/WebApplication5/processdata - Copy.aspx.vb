...
Public Class Processdata
    ...
    Public Shared Function getChartModelData(data As String)
        ...
        Dim minIntensity As Double = LCMSModel.getMinValueDouble(Model.getUV220Int)

        For i As Integer = 0 To (Model.getUV220Int.Count - 1)
            'PercentIntensity.Add(Model.getUV220Int.Item(i) / maxIntensity * 100)
            PercentIntensity.Add((Model.getUV220Int.Item(i) - minIntensity) / maxIntensity * 100)
        Next
        ...
        minIntensity = LCMSModel.getMinValueDouble(Model.getUV254Int)

        For i As Integer = 0 To (Model.getUV254Int.Count - 1)
            'PercentIntensityUV254.Add(Model.getUV254Int.Item(i) / maxIntensityUV254 * 100)
            PercentIntensityUV254.Add((Model.getUV254Int.Item(i) - minIntensity) / maxIntensityUV254 * 100)
        Next
