...
<body>
    ...
    function myFunction() {
      ...
      if (x.className === "topnav") {
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT INSTRUMENT_NAME, STATUS, QUEUE, ESTIMATED_TIME, CS_STATUS, CURRENT_SAMPLEID, USERNAME, EZX_STATUS, LAST_UPDATED, DETECT_STATE FROM INSTRUMENT_STATUS WHERE (INSTRUMENT_NAME LIKE '%LCMS%') OR (INSTRUMENT_NAME LIKE '%PREP%') ORDER BY INSTRUMENT_NAME"></asp:SqlDataSource>
        <asp:Panel ID="Panel1" runat="server" Height="600px" Width="550px"  CssClass="mypanel">
        <div id="title" >
            ...
            <br />
            <asp:Button ID="Button1" style="float:left;" runat="server" Text="Fullview" OnClientClick="target ='_blank';"/>
